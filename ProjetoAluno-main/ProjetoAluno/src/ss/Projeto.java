...
public class Projeto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        private void table_update()
        {
            ...
            con1 = DriverManager.getConnection("jdbc:mysql://localhost/fr","root","1234");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       try {
            ...
            insert = con1.prepareStatement("insert into Alunos(nome,turma,matricula)values(?,?,?)");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            insert = con1.prepareStatement("update Alunos set nome= ? ,turma=? ,matricula=? where id=? ");
            insert.setString(1, nome);
            insert.setString(2, turma);
            insert.setString(3, matrícula);
            insert.setInt(4, id);
